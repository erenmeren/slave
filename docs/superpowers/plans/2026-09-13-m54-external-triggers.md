...
Plan-time errata, every one read out of the code and baked into the tasks below. The long form, with file and line evidence, is in the session notes (`m54-plan-notes.md`); each is also to be appended to the spec's §5 during execution.
