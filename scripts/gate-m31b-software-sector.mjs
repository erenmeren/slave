...
try {
  ...
  console.log(`the seeded workspace's Team tab still renders ${seedCardCount} team card(s), matching prisma -- the software sector is untouched even with the daemon running against it`)
