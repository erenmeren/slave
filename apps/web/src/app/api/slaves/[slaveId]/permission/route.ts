 ...
 * `@@unique([slaveId, tool])`, so this is idempotent in the sense PUT promises.
 */
export async function PUT(
  ...
  // The tool string is handed on unvalidated: `setSlavePermission` owns `invalid_tool` and its
