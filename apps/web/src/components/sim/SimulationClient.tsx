...
export function SimulationClient({ initial }: { readonly initial: SimulationSnapshot }): React.JSX.Element {
  ...
  return (
    // M61 Task 10: `min-h-0`, not `min-h-screen` -- the page never scrolls (`<main>` is
    // `overflow-hidden`); this frame's own `ScrollArea` below does. The strip stays fixed above it.
